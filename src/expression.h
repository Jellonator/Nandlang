...
/// LITERAL means that this expression is already a literal does not not need
///     to be optimized.
...
void checkExpressions(const State& state,
    const std::vector<ExpressionPtr>& expressions);
/// Optimize the given list of expressions
